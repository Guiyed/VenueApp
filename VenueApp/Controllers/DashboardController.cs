...
namespace VenueApp.Controllers
{
    public class DashboardController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            HttpContext.Session.SetString("EndDate", DateTime.UtcNow.AddSeconds(4).ToString("yyyy-MM-ddTHH:mm:ss"));
            ViewBag.EndDate = HttpContext.Session.GetString("EndDate");
            ViewBag.NowDate = DateTime.UtcNow.ToString("yyyy-MM-ddTHH:mm:ss");
