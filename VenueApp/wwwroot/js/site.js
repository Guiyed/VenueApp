...
/*$("#myButton").click((e) => {
    ...
    $.ajax({
        ...
        type: "GET",
        url: "https://app.ticketmaster.com/discovery/v2/events.json?countryCode=US&city=Miami&apikey=rjvAOXYLhx1XPB30QYsgr5QVhQVO3U4b",
        async: true,
        dataType: "json",
        success: function (data) {
            console.log(data);
            // Parse the response.
            $.each(data['events'], (key, imageLink) => {
                $('div#api').append(`<img src='${imageLink}' width="200px">`);
